...
In order to determine the likelihood of 2 authors collaborating we wanted to use the (weighted) Dijkstra distance between 2 authors.
...
This gave us an indication of how strong the connection is between 2 authors that collaborated frequently.
